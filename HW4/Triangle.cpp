...
{ }
Triangle::Triangle(double sideValue,double X1,double Y1,double X2,double Y2,double X3,double Y3)
	:side(sideValue),big_a1(X1),big_a2(Y1),big_b1(X2),big_b2(Y2),big_c1(X3),big_c2(Y3)
{ }
...
void Triangle::setDegree(int valueDegree){ //Determining degree to rotating.
	degree=valueDegree;
}
//Initilizing colors.
void Triangle::setBigColor(){
	color='r';
}
void Triangle::setSmallColor(){
	s_color='g';
}
...
double Triangle::getSide() const{ return side; } // Returns side lenght of container Triangle.
double Triangle::getSmallSide() const{ return s_side; } // Returns side lenght of small Triangle.
int Triangle::getDegree() const {return degree; }
char Triangle::getbigColor() const { return color; }
char Triangle::getsmallColor() const { return s_color; }  
//Returns coordinates of Triangle corner of small and container triangle.
double Triangle::getPos_a1()  const {  return pos_a1; }
double Triangle::getPos_a2()  const {  return pos_a2; }
double Triangle::getPos_b1()  const {  return pos_b1; }
double Triangle::getPos_b2()  const {  return pos_b2; }
double Triangle::getPos_c1()  const {  return pos_c1; }
double Triangle::getPos_c2()  const {  return pos_c2; }
double Triangle::getBig_a1()  const {  return big_a1; }
double Triangle::getBig_a2()  const {  return big_a2; }
double Triangle::getBig_b1()  const {  return big_b1; }
double Triangle::getBig_b2()  const {  return big_b2; }
double Triangle::getBig_c1()  const {  return big_c1; }
double Triangle::getBig_c2()  const {  return big_c2; }
//Returns rotate coordinates.
double Triangle::getRotateX() const { return rotateX; } 
double Triangle::getRotateY() const { return rotateY; } 
