...
public:
	...
	double getSide() const{ return side; } // Returns side lenght of container Triangle.
	double getSmallSide() const{ return s_side; } // Returns side lenght of small Triangle.
